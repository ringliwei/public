  ...
  function shortVideoDownloader() {
    this.douyinVideoDownloader = function () {
      ...
      window.addEventListener("load", function () {
        //这是搜索界面
        if (
          window.location.href.match(/https:\/\/www\.douyin\.com\/search\/.*?/)
        ) {
          function downloader() {
            ...
            videoContainers.forEach((element) => {
              ...
              let playbackSetting = bottomMenu.querySelector(
          ...
          async function downloader() {
            try {
              ...
              let bottomMenu =
                bottomMenus.length > 1
                  ? bottomMenus[bottomMenuLength - 2]
                  : bottomMenus[bottomMenuLength - 1];
              let douyinVideoDownloaderDom = document.querySelector(
                "#douyin-video-downloder"
              );
              if (douyinVideoDownloaderDom) {
                douyinVideoDownloaderDom.parentNode.parentNode.removeChild(
                  douyinVideoDownloaderDom.parentNode
                );
              }
              ...
              let autoplaySetting = document.querySelector(
              ...
              let videoPlayDom =
                videoPlayers[
                  videoPlayers.length > 1
                    ? videoPlayers.length - 2
                    : videoPlayers.length - 1
                ];
              document
                .querySelector("#douyin-video-downloder")
    ...
    this.kuaishouVideoDownloader = function () {
      ...
      window.addEventListener("load", function () {
        async function downloader() {
          let kuaishouVideoDownloder = document.querySelector(
            "#kuaishou-video-downloder"
          );
